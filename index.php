<?php get_header(); ?>
  <main>
    ...
    <section id="section1" class="bg-[hsl(210_40%_96.1%/0.5)] py-44 md:py-48">
        ...
        <div class="flex flex-col w-96 bg-white rounded-lg shadow-md">
          ...
          <div class="p-5">
            ...
            <p class="mt-2 text-sm text-gray-700">
              デザインからコーディングまで一貫して対応しました。Tailwind CSS を使用して構築しており、スマートフォンやタブレットにも対応したレスポンシブデザインです。
            </p>
            <p class="mt-3 text-sm text-gray-700">「お知らせ」は WordPress の投稿機能と連携しており、管理画面から簡単に追加・編集が可能です。</p>
      ...
      <p class="text-base font-sans text-center mt-12 mx-5">
    ...
    <section id="section2" class="py-44 md:py-48">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mx-10 lg:mx-40">
        <div class="bg-gray-100 rounded-lg px-5 py-3">
          ...
          <p class="py-5">
            <span class="inline-block">HTML,</span><span class="inline-block">CSS(tailwindcss),</span><span class="inline-block">JavaScriptを</span>使って、保守性と効率性を兼ね備えたクリーンなコードを提供します。
          </p>
        </div>
        <div class="bg-gray-100 rounded-lg px-5 py-3">
          <div class="flex justify-center">
          ...
          <p class="py-5">直感的でユーザーフレンドリーなデザインを実現します。モダンなデザイントレンドを取り入れながら、ブランドイメージにマッチした魅力的なUIを構築します。</p>
        </div>
        <div class="bg-gray-100 rounded-lg px-5 py-3">
          <div class="flex justify-center">
          ...
          <p class="py-5">あらゆるデバイスで快適に閲覧できるレスポンシブデザインを実現します。スマートフォン、タブレット、PCに最適化した表示で、ユーザー体験を最大化します。</p>
        </div>
      </div>
    </section>
    ...
    <section id="section3" class="bg-[hsl(210_40%_96.1%/0.5)] py-44 md:py-48">
      ...
      <div class="md:flex items-center gap-x-10 mx-5 md:mx-32">
        ...
        <div class="basis-1/2 mx-5 md:mx-0">
          ...
          <p class="mb-2">趣味は体を動かすことで、自宅にヨガマットを引いて筋トレをするのが日課です。また、スキル向上のためにオンラインで学習を進めたり、新しい技術に触れる時間も大切にしています。</p>
          <p>新しいことを学ぶことが好きで、仕事では「細かいところまで丁寧に」をモットーにしています。デザインとエンジニアリングの両面からアプローチするものづくりを大切にし、「見る人・使う人に喜んでもらえること」を目指しています。</p>
        </div>
      </div>
    </section>
